...
export function SourceFormModal({
  ...
  function handleAddKeyword(
    e: KeyboardEvent<HTMLInputElement> | undefined = undefined,
  ) {
    if (
      (e && (e.key === ',' || e.key === ' ') && keywordInput.trim()) ||
      (!e && keywordInput.trim())
    ) {
  ...
  function handleAddDateString(
    e: KeyboardEvent<HTMLInputElement> | undefined = undefined,
  ) {
    if (
      (e && (e.key === ',' || e.key === ' ') && dateStringInput.trim()) ||
      (!e && dateStringInput.trim())
    ) {
  ...
  function handleAddContainerSelector(
    e: KeyboardEvent<HTMLInputElement> | undefined = undefined,
  ) {
    if (
      (e &&
        (e.key === ',' || e.key === ' ') &&
        containerSelectorInput.trim()) ||
      (!e && containerSelectorInput.trim())
    ) {
  ...
  function handleAddTitleSelector(
    e: KeyboardEvent<HTMLInputElement> | undefined = undefined,
  ) {
    if (
      (e && (e.key === ',' || e.key === ' ') && titleSelectorInput.trim()) ||
      (!e && titleSelectorInput.trim())
    ) {
  ...
  function handleAddDateSelector(
    e: KeyboardEvent<HTMLInputElement> | undefined = undefined,
  ) {
    if (
      (e && (e.key === ',' || e.key === ' ') && dateSelectorInput.trim()) ||
      (!e && dateSelectorInput.trim())
    ) {
  ...
  function handleAddLeadSelector(
    e: KeyboardEvent<HTMLInputElement> | undefined = undefined,
  ) {
    if (
      (e && (e.key === ',' || e.key === ' ') && leadSelectorInput.trim()) ||
      (!e && leadSelectorInput.trim())
    ) {
              ...
              <div className="space-y-4 px-6 pb-6 pt-2">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={() => handleAddKeyword(undefined)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={() => handleAddDateString(undefined)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={() => handleAddContainerSelector(undefined)}
                    placeholder="Dodaj selektor, oddziel przecinkiem"
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={() => handleAddTitleSelector(undefined)}
                    placeholder="Dodaj selektor, oddziel przecinkiem"
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={() => handleAddDateSelector(undefined)}
                    placeholder="Dodaj selektor, oddziel przecinkiem"
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={() => handleAddLeadSelector(undefined)}
                    placeholder="Dodaj selektor, oddziel przecinkiem"
